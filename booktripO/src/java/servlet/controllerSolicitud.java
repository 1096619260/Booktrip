...
import static pruebas.pruebaAdicionarSolicitudInmueble.solicitud;
...
public class controllerSolicitud extends HttpServlet {
    ...
    solicitudinmueblesDAO dao=new solicitudinmueblesDAO();
     inmuebles s=new inmuebles();
inmueblesDAO sdao=new inmueblesDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<inmuebles> listainmuebles=sdao.ConsultarListadoInmueble("");
        request.setAttribute("listaP", listainmuebles);
        ...
        switch (accion) {
            case "Listar":
                ...
                request.getRequestDispatcher("listaSolicitud.jsp").forward(request, response);
                break;
            case "Nuevo":                
                request.getRequestDispatcher("solicitud/add.jsp").forward(request, response);
                break;
            case "Guardar":
